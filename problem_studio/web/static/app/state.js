...
export const state = {
  ...
  lastRun: null,
  unsaved: {
    file: { contextKey: "", path: "", savedContent: "" },
    metadata: { contextKey: "", savedCanonicalDraft: "" },
    solutionModal: { contextKey: "", mode: "", path: "", savedCanonicalDraft: "" },
  },
  ...
  latestSolutionVerificationByContext: {},
  activeSolutionTestsByPath: {},
  lastStreamDetail: "",
  tabSelections: {},
  problemFolderCollapsed: {},
  problemFilter: "",
  problemListScrollByContext: {},
  resourceFilters: {},
  activeModalTrigger: null,
  activeModalTriggerId: "",
  activeModalTriggerAction: "",
  activePackJob: null,
...
export const TAB_CONFIGS = {
  ...
  generator: {
    ...
    actions: [
      { id: "compileCases", label: "케이스 파일 검사", primary: true },
      { id: "compileGenerator", label: "생성기 컴파일" },
      { id: "generateSample", label: "샘플 데이터 생성" },
      { id: "generateHidden", label: "숨김 데이터 생성" },
    ],
  },
  validator: {
    title: "데이터 검증",
    ...
    actions: [
      { id: "compileValidator", label: "검증기 컴파일", primary: true },
  ...
  checker: {
    ...
    actions: [
      { id: "compileChecker", label: "채점기 컴파일", primary: true },
  ...
  solutions: {
    ...
    actions: [
      ...
      { id: "stressSolutions", label: "스트레스 테스트" },
    ],
  },
  build: {
    title: "검증/빌드",
